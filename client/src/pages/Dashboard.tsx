...
export default function Dashboard() {
 ...
 className="p-6 bg-gradient-to-br from-red-600 to-red-800 rounded-xl shadow-lg hover:shadow-2xl hover:-translate-y-1 transition-all text-left border-2 border-red-500"
 >
 ...
 <h3 className="text-lg font-semibold text-white mb-2">🔐 Painel de Administração</h3>
 <p className="text-red-100 text-sm font-medium">
 Gerenciar usuários, assinaturas e receita
 </p>
 </button>
 )}
 </div>
