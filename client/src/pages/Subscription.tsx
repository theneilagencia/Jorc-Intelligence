    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-slate-600">Carregando informações da assinatura...</p>
        </div>
      </div>
    );
  }
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-slate-600 mt-1">Visualize e gerencie seu plano e faturas</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="lg:col-span-2 bg-white rounded-xl shadow-sm border border-slate-200 p-6">
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
              <div className="bg-[#000020] rounded-lg p-4">
                ...
                <div className="flex items-baseline gap-1">
                  <span className="text-2xl font-bold text-slate-900">{stats.reportsUsed}</span>
              ...
              <div className="bg-[#000020] rounded-lg p-4">
                ...
                <div className="flex items-baseline gap-1">
                  <span className="text-2xl font-bold text-slate-900">{stats.projectsActive}</span>
                  <span className="text-sm text-slate-600">
            ...
            {subscription && (
              <div className="border-t border-slate-200 pt-6">
                <h3 className="text-lg font-semibold text-slate-900 mb-4">Detalhes da Assinatura</h3>
                <div className="space-y-3">
                  <div className="flex justify-between">
                    <span className="text-slate-600">Período atual</span>
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-mono text-sm text-slate-600">{subscription.id}</span>
                  </div>
                </div>
              </div>
            )}
            ...
            {!isFree && license.plan === 'PRO' && (
              <div className="bg-gradient-to-br from-purple-600 to-purple-700 rounded-xl shadow-sm p-6 text-white">
                ...
                <button
                  ...
                  className="w-full px-4 py-2 bg-white text-purple-600 rounded-lg hover:bg-purple-50 transition font-medium disabled:opacity-50"
                >
        ...
        {invoices.length > 0 && (
          <div className="mt-8 bg-white rounded-xl shadow-sm border border-slate-200 p-6">
            <h2 className="text-2xl font-bold text-slate-900 mb-6">Histórico de Faturas</h2>
