...
from app.modules.radar.routes import router as radar_router
...
async def root():
    ...
    return {
        ...
        "modules": [
            ...
            "✅ bridge - Tradução normativa cross-norm (ATIVO)",
            "✅ radar - Monitoramento regulatório global (ATIVO - NOVO!)",
